  ...
  return [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          risk: { type: 'string', enum: ['1', '2', '3', '4'], description: '1=High, 2=Medium, 3=Low, 4=Very Low' },
          impact: { type: 'string', enum: ['1', '2', '3'], description: '1=High, 2=Medium, 3=Low' },
          priority: { type: 'string', enum: ['1', '2', '3', '4'], description: '1=Critical, 2=High, 3=Moderate, 4=Low' },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          state: { ...CHANGE_STATE, description: 'Filter by change state. ' + CHANGE_STATE.description },
